...
router.post('/edit_product', async (req, res) => {
  try {
    ...
    if (req.body.new_description !== "") {
      updateObject.description = req.body.new_description;
    }
    if (req.body.new_filepath !== "") {
      updateObject.imagePath = req.body.new_filepath;
    }
    if (req.body.new_price !== "") {
      updateObject.price = req.body.new_price;
    }
